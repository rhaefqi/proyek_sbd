...
<head>
  ...
  <!-- <script src="https://kit.fontawesome.com/a7967929ef.js" crossorigin="anonymous"></script> -->
</head>
      ...
      <div class="col-8">
        <form method="POST" enctype="multipart/form-data">
          ...
          <div class="container">
            <div class="card">
              <div class="card-body">
                <input type="text" class="form-control" id="judulresep" placeholder="Judul : Sup Ayam Favorit Keluarga"
                  style="font-size: 30px; font-weight: bold;">
              </div>
              <div class="card-body">
                <textarea class="form-control" rows="5" id="ceritaresep" style="font-size: 15px;"
              ...
              <div class="card-body">
                  ...
                  <div class="row g-2 row-cols-3 d-flex justify-content-center">
                    ...
                    <div class="col-10">
                      <input type="text" class="form-control  " id="bahan"
                        placeholder="Potong Ayam menjadi beberapa bagian">
                    </div>
                    <div class="col-1">
                      <img src="../asset/img/more.png" alt="" width="50%">
                    </div>
                    ...
                    <div class="col-10 ">
                      ...
                      <p class="image_upload">
                        <label for="userImage" id="labelupload">
                          <a class="btn btn-warning" rel="nofollow">
                            <span class="bi bi-paperclip"></span> Sisipkan Gambar</a>
                        </label>
                ...
                <div id="langkahmasakan" class="langkahadd">
                  <div class="row g-2 row-cols-3 d-flex justify-content-center">
                    ...
                    <div class="col-10">
                      <input type="text" class="form-control" id="bahan3"
                        placeholder="Potong Ayam menjadi beberapa bagian">
                    </div>
