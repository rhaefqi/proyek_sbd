    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div style="color: #FFA347; font-size: 30px; font-weight: 900; text-transform: uppercase;">SELAMAT DATANG <?php echo $name; ?>!</div><br>
                <img src="asset/img/admin/masak4.jpeg" alt="" style="width: 400px; display: block; margin: 0 auto; border-radius:50px;">
                </div>
