...
<body>
    ...
    <div id="wrapper">
        ...
        <img src="asset/img/admin/masak3.jpeg" class="col-md-6 float-md-end mb-3 ms-md-3" 
        style="width: 300px; border-radius: 50px;">
        <h1 class="clearfix_top warna" style="padding-top: 80px;">
        Halo <?= $name; ?> <br> Silahkan Tambah Aktivitas
        </h1>
        </div>
        </div>
        </div>
          ...
          <form method="POST">
          <button type="submit" name="aktivitas" class="tambah mb-2">Kirim</button>
          <textarea name="pesan" id="wysiwyg-editor"></textarea>
          </form>
          <br>
          </div>
        </div>
